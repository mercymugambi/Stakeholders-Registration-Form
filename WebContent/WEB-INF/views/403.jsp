				...
				<div class="secondary">
					<div class="container-960">
						...
						<ul class="topnav pull-left">
							...
							<li><a href="index.html" class="glyphicons home"><i></i></a></li>
							<li class="Active"><a href="/BriskWS/">Home</a></li>


						</ul>

						<!-- Brand -->
						<!-- <a href="/DrugIndex/index.html" class="appbrand pull-left"><img src="top_logo.png"></a> -->
						...
						<ul class="topnav pull-right">
							...
							<!-- <li><a href="sms-login.html" class="glyphicons shield"><i></i> SMS Login</a></li> -->
							<li class="glyphs hidden-phone">
								<ul>
								
									<c:if test="${empty user}">
										<li><a href="/BriskWS/login.html" class="glyphicons unlock"><i></i>
												Sign in</a></li>
									...
									<c:if test="${not empty user}">
										...
										<li class="dropdown dd-1"><a href=""
											data-toggle="dropdown">Welcome ${user.name}<span
												class="caret"></span>
										</a></li>

										<li><a href="/BriskWS/j_spring_security_logout"
											class="glyphicons user_add"><i></i> Log Out</a></li>
									</c:if>
			...
			<div id="login">
				...
				<div class="container">
					...
					<div class="wrapper">
							...
							<h1>You are not allowed to access this functionality</h1>
							<h2>${msg}</h2>
