			...
			<div class="navbar main hidden-print">
				...
				<div class="secondary">
					<div class="container-960">
						...
						<!-- Brand -->
						<a href="/BriskAFA/user/registration" class="appbrand pull-left">
							<img src="<c:url value="/resources/images/ASKSLEEK.jpg"/>">
						</a>
						...
						<ul class="topnav pull-right">
							...
							<li><a href="#" class="glyphicons shield"><i></i> Get
									Help</a></li>
							<li class="glyphs hidden-phone">
								<ul>
									<%-- <c:if test="${empty user}">
										<li><a href="login.html" class="glyphicons unlock"><i></i>
												Sign in</a></li>
										<li><a href="signup.html" class="glyphicons user_add"><i></i>
												Sign up</a></li>
									</c:if> --%>
				...
				<div class="container-960">
					...
					<ul class="topnav pull-left">
						...
						<%-- 	<li class="active"><a href="/DrugIndex/index.html"
							class="glyphicons home"><i></i></a></li>
						<li><a href="/DrugIndex/user/brands.html">Medicine Brands</a></li>
						<li><a href="/DrugIndex/user/ingredients.html">Active
								Ingredients</a></li>
						<li class="dropdown dd-1"><a href="" data-toggle="dropdown">Disease
								Guide<span class="caret"></span>
						</a>
							<ul class="dropdown-menu pull-left">
								<li class=""><a href="/DrugIndex/user/disease.html">Drug
										Disease Correlation</a></li>
								<li class=""><a href="#">Drugs by Condition</a></li>
								<li class=""><a href="#">Side Effects</a></li>
							</ul></li>
						<li><a href="#" class="glyphicons iphone"><i></i></a></li> --%>

					</ul>

					<!-- Top Menu Right -->
					<%-- <ul class="topnav pull-right border-none">

						<li class="search open margin-none border-none box-shadow-none">
							<sf:form method="post" action="search" commandName="searchForm"
								autocomplete="off" class="dropdown dd-1">
														<sf:input path="activeIngredientName" type="text" value="" placeholder="Search for active ingredient .." data-toggle="typeahead" />

								<button type="submit" class="glyphicons search">
									<i></i>
								</button>
							</sf:form>
						</li>
									...
									<div class="span12">
										...
										<c:if test="${empty message}">
											...
											<c:if test="${empty fullUrl}">
												<sf:form method="post" action="/OnlineTicket/user/hashUrl"
													...
													<div class="register">
														...
														<font color="red"> <sf:errors path="surname"
																cssClass="error" /></font> <label class="strong">Surname</label>
														<sf:input id="surname" path="surname" type="text"
															class="input-block-level" placeholder="surname" />
														<font color="red"> <sf:errors path="surname"
																cssClass="error" /></font> <label class="strong">Othernames</label>
														<sf:input id="otherNames" path="otherNames" type="text"
															class="input-block-level" placeholder="Othernames" />
														<font color="red"> <sf:errors path="otherNames"
																cssClass="error" /></font> 
														...
														<font color="red"> <sf:errors path="idNumber"
																cssClass="error" /></font>
														...
														<sf:input id="phoneNumber" path="phoneNumber" type="telephone"
															class="input" placeholder="254712345678" />
												       ...
												       <label class="strong">Company
														...
														<sf:input path="ttl" type="ttl" class="register-input"
															placeholder="amount" /> --%>
														</br> </br> <input type="submit" value="Make Payment"
											...
											<c:if test="${empty message}">
												...
												<c:if test="${not empty fullUrl}">
													<%-- <iframe src="${fullUrl}" frameborder="0" scrolling="yes"
